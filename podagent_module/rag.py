...
class ConversationalAgenticRAG:
    ...
    def delete_all_vector_stores(self):
        ...
        vector_stores = self.__vector_store_manager.list_disk_stores()
        for store in vector_stores:
            self.__vector_store_manager.delete_store(store)
    ...
    def indexing(self):
        ...
        self.__vector_store_manager.delete_store(self.__vector_store_name)
